...
const getContent = (type: OtpEmailType) => {
  switch (type) {
    case "sign-in":
      return {
        preview: "Your GHOST ID Sign-In Code",
        heading: "Your Sign-In Code",
        description: "Here is your one-time password to sign in to GHOST ID:",
      };
    case "email-verification":
      return {
        preview: "Verify Your Email Address",
        heading: "Verify Your Email",
        description: "Here is your verification code for GHOST ID:",
      };
    case "forget-password":
      return {
        preview: "Reset Your Password",
        heading: "Reset Your Password",
        description: "You requested to reset your password for GHOST ID. Here is your one-time password:",
      };
  }
};
        ...
        <Body className="bg-lightBg font-sans">
          <Container className="mx-auto py-10 px-6 max-w-[600px]">
            ...
            <Section className="text-center border-t border-borderColor pt-5">
              <Text className="text-mutedText text-xs">© {currentYear} GHOST ID Analytics</Text>
            </Section>
          </Container>
        </Body>
      </Tailwind>
