    ...
    <div className="bg-neutral-100/50 dark:bg-neutral-800/20 backdrop-blur-sm border border-neutral-300/50 dark:border-neutral-800/50 rounded-xl overflow-hidden">
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          <AccordionTrigger className="md:text-lg">Is GHOST ID GDPR and CCPA compliant?</AccordionTrigger>
          <AccordionContent>
            Yes, GHOST ID is fully compliant with GDPR, CCPA, and other privacy regulations. We don&apos;t use
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger className="md:text-lg">GHOST ID vs. Google Analytics</AccordionTrigger>
          <AccordionContent>
            <p>
              Google Analytics is free because Google uses it as a funnel into their ecosystem and to sell ads.
              GHOST ID&apos;s only goal is to provide you with high quality analytics. No more confusing
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger className="md:text-lg">GHOST ID vs. Plausible/Umami/Fathom</AccordionTrigger>
          <AccordionContent>
            <p>
              GHOST ID is similar to these simple and privacy-focused analytics platforms, but we are raising the
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger className="md:text-lg">GHOST ID vs. Posthog/Mixpanel/Amplitude</AccordionTrigger>
          <AccordionContent>
            <p>
              GHOST ID has most of the features of enterprise analytics platforms, but packaged in a way that is
        ...
        <AccordionItem value="item-5">
          <AccordionTrigger className="md:text-lg">Can I self-host GHOST ID?</AccordionTrigger>
          <AccordionContent>
            Absolutely! GHOST ID is available as a self-hosted option. You can install it on your own server and
        ...
        <AccordionItem value="item-6">
          <AccordionTrigger className="md:text-lg">How easy is it to set up GHOST ID?</AccordionTrigger>
          <AccordionContent>
            <Link
              href="/docs/script"
              className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300"
            ...
            is incredibly simple. Just add a small script to your website or install @ghost-id/js from npm, and
        ...
        <AccordionItem value="item-7">
          <AccordionTrigger className="md:text-lg">What platforms does GHOST ID support?</AccordionTrigger>
          <AccordionContent>
            GHOST ID works with virtually any website platform. Whether you&apos;re using WordPress, Shopify,
            Next.js, React, Vue, or any other framework, our simple tracking snippet integrates seamlessly. You
            can also use @ghost-id/js, our web SDK you can install from npm. Check out our{" "}
            <Link
              href="/docs"
              className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300"
            >
        ...
        <AccordionItem value="item-8">
          <AccordionTrigger className="md:text-lg">Is GHOST ID open source?</AccordionTrigger>
          <AccordionContent>
            Yes, GHOST ID is open source under the AGPL v3.0 license. You are free to{" "}
            <Link
              href="/docs/self-hosting"
              className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300"
            >
        ...
        <AccordionItem value="item-11">
          <AccordionTrigger className="md:text-lg">Does GHOST ID have an API?</AccordionTrigger>
          <AccordionContent>
            Yes, GHOST ID provides a comprehensive{" "}
            <Link
            ...
            that allows you to programmatically access your analytics data. You can integrate GHOST ID data into
