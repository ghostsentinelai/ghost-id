...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://ghost-id.com/tools/marketing-roi-calculator",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://ghost-id.com/tools/marketing-roi-calculator",
  },
};
...
export default function MarketingROICalculatorPage() {
  return (
    <ToolPageLayout
      ...
      ctaTitle="Track your marketing ROI with GHOST ID"
