...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://ghost-id.com/tools/privacy-policy-builder",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://ghost-id.com/tools/privacy-policy-builder",
  },
};
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Under GDPR and similar regulations, IP addresses and analytics data can be considered personal data. However, privacy-focused analytics tools like GHOST ID don't use cookies and anonymize data, making compliance much easier. If you use GHOST ID, you typically won't need a cookie consent banner.",
          },
        },
        {
          "@type": "Question",
...
export default function PrivacyPolicyBuilderPage() {
  return (
    <ToolPageLayout
      ...
      ctaDescription="GHOST ID doesn't use cookies and anonymizes all data, making GDPR and CCPA compliance simple. No cookie banners needed."
