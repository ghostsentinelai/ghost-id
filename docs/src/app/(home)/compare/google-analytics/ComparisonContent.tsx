    ...
    <div className="space-y-6 text-neutral-350 font-light">
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          The fundamental difference between GHOST ID and Google Analytics lies in our approach to privacy. While Google
          Analytics collects vast amounts of personal data requiring cookie consent banners to comply with GDPR and
          CCPA, GHOST ID is built privacy-first. We don't use cookies, don't track personal information, and are compliant
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          GHOST ID fills this gap perfectly: we provide comprehensive features including session replay, user profiles,
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          GHOST ID's lightweight script loads from a global CDN, ensuring minimal impact on your site's performance while
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          15-30% of your visitors. GHOST ID gives you 100% accurate, real-time data with no sampling ever. We're less
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          While Google Analytics shows you what happened through numbers and charts, GHOST ID provides a comprehensive
          ...
          visitor activity. Features like public dashboards and organization support make GHOST ID perfect for agencies
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          ...
          GHOST ID is open source (AGPL v3) with thousands of stars on GitHub, meaning you can inspect our code,
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Google Analytics is "free" because you're the product. Your data feeds their advertising empire. GHOST ID has a
      ...
      <div className="space-y-4">
        ...
        <p className="leading-relaxed">
          Unlike Google Analytics where you need to implement tracking before seeing any interface, GHOST ID offers a live
