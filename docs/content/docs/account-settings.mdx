...
Generate API keys to access GHOST ID's analytics endpoints from your applications.
...
Include your API key in requests to GHOST ID's API endpoints. See the [API documentation](/docs/api) for available endpoints and usage examples.
