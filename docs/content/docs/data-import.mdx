...
The data import feature allows you to migrate your historical analytics data from other platforms to GHOST ID. This preserves your analytics history when switching from competitors, giving you a complete view of your data without losing valuable insights.
...
Currently, GHOST ID supports importing data from:
...
1. Open your GHOST ID dashboard
...
- Continue using GHOST ID while the import runs
...
**Imported Events**
- Number of events successfully imported into GHOST ID
