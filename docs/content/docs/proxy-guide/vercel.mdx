...
description: Deploy GHOST ID proxy on Vercel with Edge Network caching
---

import { Steps } from 'fumadocs-ui/components/steps';
import { Callout } from 'fumadocs-ui/components/callout';

Vercel makes it easy to proxy GHOST ID tracking through their Edge Network. If you're using Next.js, follow the [Next.js proxy guide](/docs/proxy-guide/next-js) instead, which is optimized for Next.js applications.
...
**What you'll achieve:**
- Proxy GHOST ID through Vercel's Edge Network
  ...
  "rewrites": [
    {
      ...
      "destination": "https://app.ghost-id.io/api/script.js"
    },
    {
      "source": "/analytics/replay.js",
      "destination": "https://app.ghost-id.io/api/replay.js"
    },
    {
      "source": "/analytics/metrics.js",
      "destination": "https://app.ghost-id.io/api/metrics.js"
    },
    {
      "source": "/analytics/track",
      "destination": "https://app.ghost-id.io/api/track"
    },
    {
      "source": "/analytics/identify",
      "destination": "https://app.ghost-id.io/api/identify"
    },
    {
      "source": "/analytics/session-replay/record/:siteId",
      "destination": "https://app.ghost-id.io/api/session-replay/record/:siteId"
    },
    {
      "source": "/analytics/site/tracking-config/:siteId",
      "destination": "https://app.ghost-id.io/api/site/tracking-config/:siteId"
    }
  ]
}
```
...
```bash
git add vercel.json
git commit -m "Add GHOST ID proxy configuration"
git push
```
...
3. **Verify in GHOST ID dashboard**: Data should appear after 1-2 minutes
...
2. Edge server rewrites and proxies to GHOST ID
...
**Problem**: Requests still go to `app.ghost-id.io` directly.
...
// vercel.staging.json (staging)
{
  "rewrites": [
    {
      "source": "/analytics/script.js",
      "destination": "https://staging.ghost-id.io/api/script.js"
    }
  ]
}
```
...
```json
// ❌ Wrong - uses redirects (user sees app.ghost-id.io)
{
  "redirects": [
    {
      "source": "/analytics/script.js",
