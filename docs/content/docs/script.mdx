...
description: How to install and configure the GHOST ID tracking script
---

import { Callout } from 'fumadocs-ui/components/callout';

To start tracking user activity on your website, add the GHOST ID tracking script to your site's HTML.
...
```
If you are self-hosting GHOST ID `app.ghost-id.io` will be domain of your GHOST ID instance.
...
Most tracking options are configured through your site settings in the GHOST ID dashboard. The script automatically fetches these settings when it loads:
