---
title: Drupal
description: Integrate GHOST ID Analytics with your Drupal site using theme files or modules
---

import { Steps, Step } from 'fumadocs-ui/components/steps';
import { Callout } from 'fumadocs-ui/components/callout';

Integrating GHOST ID Analytics with your Drupal site can be done by adding the tracking script to your theme or by using a module that allows adding custom JavaScript.
...
Open the `html.html.twig` file and paste the GHOST ID tracking script just before the closing `</body>` tag.
...
- Click **+ Add JS inject**.
- **Label:** Give it a name like "GHOST ID Analytics".
- **Code:** Paste your GHOST ID tracking script into the code field.
...
That's it! GHOST ID Analytics should now be integrated with your Drupal site.