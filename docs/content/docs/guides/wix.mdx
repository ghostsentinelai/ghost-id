---
title: "Wix"
description: "Integrate GHOST ID Analytics with your Wix website using custom code snippets."
---

import { Steps, Step } from 'fumadocs-ui/components/steps';
import { Callout } from "fumadocs-ui/components/callout";

Integrating GHOST ID Analytics with your Wix website involves adding a custom code snippet to your site's tracking tools.
...
- **Paste your GHOST ID tracking script** into the main code snippet box.
- **Name your code:** Give it a recognizable name, like "GHOST ID Analytics".
...
After applying the changes, GHOST ID Analytics should start tracking visitors on your Wix site.
...
That's it! GHOST ID Analytics is now integrated with your Wix website.