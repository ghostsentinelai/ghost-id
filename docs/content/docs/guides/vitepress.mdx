---
title: VitePress
description: Integrate GHOST ID Analytics with your VitePress documentation site
---

import { Tabs, Tab } from 'fumadocs-ui/components/tabs';
import { Callout } from 'fumadocs-ui/components/callout';

VitePress is a static site generator powered by Vite and Vue, commonly used for documentation. Here's how to add GHOST ID Analytics to your VitePress site.

## How to Add GHOST ID to VitePress

<Tabs items={['Config File (Recommended)', 'Custom Theme']}>
<Tab>
### Using VitePress Config

The simplest way to add GHOST ID is through your VitePress configuration file.
...
VitePress uses client-side navigation between pages. The GHOST ID script automatically tracks page views during SPA navigation, so no additional configuration is needed.
