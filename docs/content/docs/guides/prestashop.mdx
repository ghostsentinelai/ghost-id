---
title: PrestaShop
description: Integrate GHOST ID Analytics with your PrestaShop store
---
...
PrestaShop is a popular open-source e-commerce platform. Here's how to add GHOST ID Analytics to track visitors and conversions on your PrestaShop store.

## How to Add GHOST ID to PrestaShop
