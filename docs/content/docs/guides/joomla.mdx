---
title: Joomla
description: Integrate GHOST ID Analytics with your Joomla website
---
...
Joomla is a popular open-source content management system. Here's how to add GHOST ID Analytics to your Joomla site.

## How to Add GHOST ID to Joomla
...
- **Title**: GHOST ID Analytics (or any name you prefer)
- **Show Title**: No
