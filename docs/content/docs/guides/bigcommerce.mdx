---
title: BigCommerce
description: Integrate GHOST ID Analytics with your BigCommerce store
---
...
BigCommerce is a leading e-commerce platform for online stores. You can integrate GHOST ID Analytics to track visitor behavior and conversions.

## How to Add GHOST ID to BigCommerce

<Tabs items={['Script Manager (Recommended)', 'Theme Files']}>
<Tab>
### Using Script Manager

The easiest way to add GHOST ID to BigCommerce is through the Script Manager.
...
- **Name**: GHOST ID Analytics
- **Description**: GHOST ID Analytics tracking script
- **Placement**: Head
- **Location**: All pages
...
To get the most out of GHOST ID with BigCommerce, you can track key e-commerce events like product views and purchases.
...
<script>
(function() {
  function waitForGHOST ID(callback, timeout) {
    var start = Date.now();
    (function check() {
